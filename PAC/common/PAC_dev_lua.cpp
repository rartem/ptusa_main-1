...
/* method: instant_off of class  dev_stub */
#ifndef TOLUA_DISABLE_tolua_PAC_dev_dev_stub_instant_off00
static int tolua_PAC_dev_dev_stub_instant_off00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
